...
const partnerNames = ['Marc', 'Neal', 'Davy', 'Polly', 'Cedric'];

const locations = ['Rome', 'Paris', 'Berlin', 'Brussels', 'Amsterdam'];

const jobTitles = ['Doctor', 'Driver', 'Teacher', 'Director', 'Developer'];
